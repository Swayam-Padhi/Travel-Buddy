		...
		<div name="about" className="about md:bg-about bg-cover bg-top w-full h-full md:h-screen">
          ...
          Bringing the world to you
				...
				<p className="my-4 text-center">
					Travel Buddy was founded in 2023, <em className="text-teal-400"> for travelers to find their travel buddies and explore new destinations....</em>.
				</p>
				<div className="flex flex-wrap justify-evenly items-start md:bg-[#ffffff8a] rounded-lg leading-loose">
					<div className="w-full md:w-1/2 p-4">
						...
						next getaway with new buddies. Our core belief is that everyone should travel, and it
						is vital that we make sure that they don't travel alone.
					</div>
					<div className="w-full md:w-1/2 p-4">
					“The more I traveled the more I realized that fear makes strangers of people who should be friends”
					<div>         —Shirley MacLaine    </div>

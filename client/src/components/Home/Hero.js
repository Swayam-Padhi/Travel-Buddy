...
import Video from '../../assets/buddy.mp4';
		...
		<>
			<div className="hero w-full h-screen relative text-white">
				...
				<div className="content w-full h-full m-auto p-4 absolute top-0 flex flex-col justify-center items-center">
					<h1 className="text-2xl md:text-5xl">In life, it's not where you go</h1>
					<h2 className="my-4 text-xl md:text-4xl">It's who you travel with.</h2>
